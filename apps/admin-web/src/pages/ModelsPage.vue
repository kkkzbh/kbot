        ...
        <div v-if="selectedConnection" class="connection-editor">
          ...
          >
            <div class="catalog-heading">
              <h4 id="available-models-title">
                可用模型
                <span
                  v-if="selectedCatalog"
                  class="catalog-count"
                  :aria-label="`${selectedCatalog.models.length} 个模型`"
                >
                  {{ selectedCatalog.models.length }}
                </span>
              </h4>
            </div>
