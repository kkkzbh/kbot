...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/intelligence/agent', name: 'agent', component: () => import('@/pages/AgentPage.vue'), meta: { title: 'Agent 能力' } },
    { path: '/policies', name: 'policies', component: () => import('@/pages/PoliciesPage.vue'), meta: { title: '工具策略' } },
