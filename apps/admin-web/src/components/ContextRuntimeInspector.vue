...
<style scoped>
.runtime-inspector{display:grid;gap:24px;max-width:1320px;margin:24px auto 0;padding-top:16px;border-top:1px solid var(--line);color:var(--ink)}.runtime-head{display:flex;align-items:center;justify-content:space-between;gap:24px}.runtime-head h2{margin:0;font-size:15px;letter-spacing:-.01em}.runtime-actions{display:flex;align-items:center;gap:8px}.runtime-actions .el-select{width:280px}.request-meta{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:1px;margin:0;border:1px solid var(--line);background:var(--line)}.request-meta div{min-width:0;padding:13px 14px;background:var(--surface)}.request-meta dt{color:var(--muted);font-size:10px;text-transform:uppercase}.request-meta dd{overflow:hidden;margin:5px 0 0;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.raw-section{display:grid;gap:14px}.section-title{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.section-title h2,.empty-snapshot h2{margin:0;font-size:17px;letter-spacing:-.02em}.secondary-links{display:flex;gap:2px}.raw-payload{margin:0}.raw-list{border-top:1px solid var(--line)}.raw-item{position:relative;border-bottom:1px solid var(--line)}.raw-item-head{display:flex;width:100%;align-items:center;justify-content:space-between;gap:18px;min-height:60px;padding:9px 7px;border:0;background:transparent;color:inherit;text-align:left;cursor:pointer}.raw-item-head>span{display:flex;align-items:baseline;gap:10px;min-width:0}.raw-item-head strong{font-size:13px}.raw-item-head em{color:var(--accent);font-family:var(--font-mono,ui-monospace,monospace);font-size:12px;font-style:normal}.raw-item-head small,.raw-item-head>span:last-child{overflow:hidden;color:var(--muted);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.raw-item-payload{margin:0 7px 14px}.tool-item{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center}.tool-item .raw-item-payload{grid-column:1/-1}.tool-item>.el-switch{margin-right:7px}.excluded-toggle{justify-self:start;padding:2px 0;border:0;background:transparent;color:var(--muted);font:inherit;font-size:12px;cursor:pointer}.excluded-list{opacity:.72}.empty-line{margin:0;padding:20px 7px;border-top:1px solid var(--line);border-bottom:1px solid var(--line);color:var(--muted);font-size:13px}.empty-snapshot{display:grid;gap:10px;padding:44px 4px;border-top:1px solid var(--line)}.empty-snapshot>p{margin:0;color:var(--muted);font-size:13px;line-height:1.6}@media(max-width:900px){.request-meta{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:680px){.runtime-head,.section-title{align-items:stretch;flex-direction:column}.runtime-actions{align-items:stretch}.runtime-actions .el-select{width:100%}.request-meta{grid-template-columns:repeat(2,minmax(0,1fr))}.raw-item-head>span:first-child{align-items:flex-start;flex-direction:column;gap:3px}}
</style>
