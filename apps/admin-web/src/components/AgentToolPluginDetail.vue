    ...
    <section class="detail-section">
      ...
      <div v-if="tools.length" class="tool-list">
        <article v-for="tool in tools" :key="tool.name" class="tool-row">
          <button type="button" class="tool-select" @click="emit('openTool', tool.name)">
